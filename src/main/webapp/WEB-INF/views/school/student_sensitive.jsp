...
$(function () {
    ...
    $table.bootstrapTable({
        url:"<%=basePath%>school/getAllSensittive",
        dataType:"json",
        search:"true",
        pagination:"true",
    ...
    function weiboIdFormatter(value, row, index) {
        value = "<a href='/school/toPage?page=school/weibo_info&weiboId="+row['weiboId']+"'>"+row['weiboId']+"</a>";
        console.log(value);
        return value;
    }
